...
from app.infrastructure.db.models import RefreshTokenORM, default_refresh_token_expires_at
...
class RefreshToken(DomainModel):
    ...
    expired_at: datetime = field(default_factory=default_refresh_token_expires_at)
